      ...
      <div className="container mx-auto px-6 text-center">
        <div className="max-w-3xl mx-auto">
          ...
          <p className="text-lg text-brand-gray">
            Com base em Porto Alegre, oferecemos nossos serviços de perícia e assistência técnica em engenharia elétrica para todas as comarcas do estado do Rio Grande do Sul, garantindo agilidade e presença onde for necessário.
          </p>
        </div>
      </div>
    </section>
